...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            ...
            <p class="auth-subtitle mb-5">Masukkan Email untuk mereset password anda </p>
		...
		@csrf
 		    ...
 		    @error('email')
                ...
                <button class="btn btn-primary btn-block btn-lg shadow-lg mt-5" type="submit">  {{ __('Send Password Reset Link') }}</button>
            </form>
